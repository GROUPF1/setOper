...
import logging
logger = logging.getLogger('kishor_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by KishorWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseKishorWindow object.
        """
        builder = get_builder('KishorWindow')
        new_object = builder.get_object("kishor_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a KishorWindow object with it in order to finish
        initializing the start of the new KishorWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.kishor")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('kishor')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for kishor."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for kishor."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the KishorWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the KishorWindow is closed."""
